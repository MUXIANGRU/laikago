...
static uint64_t __lcmtest_primitives_t_hash;

uint64_t __lcmtest_primitives_t_hash_recursive(const __lcm_hash_ptr *p)
{
    ...
    __lcm_hash_ptr cp;
    cp.parent =  p;
    cp.v = __lcmtest_primitives_t_get_hash;
    (void) cp;

    uint64_t hash = (uint64_t)0xc2731598914f36aaLL
...
int64_t __lcmtest_primitives_t_get_hash(void)
{
    if (!__lcmtest_primitives_t_hash_computed) {
        __lcmtest_primitives_t_hash = (int64_t)__lcmtest_primitives_t_hash_recursive(NULL);
